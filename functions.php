...
function lawyeria_lite_enqueue_style() {
    ...
    wp_enqueue_style( 'custom_style', get_template_directory_uri() . '/css/custom.css',array('lawyeria_lite_style'), '1.0.0' );
    wp_enqueue_style( 'lato', get_stylesheet_directory_uri() . 'https://fonts.googleapis.com/css?family=Lato',array(), '1.0.0' );

    wp_enqueue_style( 'twentytwenty_style', get_template_directory_uri() . '/css/twentytwenty.css',array(), '1.0.0' );
}
...
function lawyeria_lite_enqueue_scripts() {
    ...
    wp_enqueue_script( 'jquery_event_move', get_template_directory_uri() . 'js/jquery.event.move.js', array( 'jquery' ), '1.0', true );
    wp_enqueue_script( 'jquery_twentytwenty', get_template_directory_uri() . 'js/jquery.twentytwenty.js', array( 'jquery' ), '1.0', true );
